...
| **Edit existing items**         | Only a logged-in can edit an item, including its name, SKU, quantity, and category using the “View Details” button on the Manage Inventory page.                                                                                                                                                                                                                                                 |    Works as expected        |
